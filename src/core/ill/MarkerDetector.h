#ifndef _MarkerDetector1_H
#define _MarkerDetector1_H
 ...
 *
 */
class MarkerDetector1 : public QObject{
...
public:
     ...
     *
     */
    void setMakerDetectorFunction(int (* MarkerDetector1_func)(const cv::Mat &in,int &nRotations) ) {
        markerIdDetector_ptrfunc=MarkerDetector1_func;
    }
